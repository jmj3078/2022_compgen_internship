#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/opt/biogrids/x86_64-linux/strelka/2.9.2/bin/configureStrelkaSomaticWorkflow.py --normalBam ./bam/Targeted_C_Normal.sorted.RGadded.marked.realigned.fixed.recal.bam --tumorBam ./bam/Targeted_C_Disease.sorted.RGadded.marked.realigned.fixed.recal.bam --referenceFasta /data/references/b37/human_g1k_v37_decoy.fasta --callRegions ./bed/targeted.bed.gz --runDir ./Targeted_C_strelka'
#
...
sys.path.append(r'/opt/biogrids/x86_64-linux/strelka/2.9.2/lib/python')
...
main(r"/scratch/2022_summer_internship/mjcho/FCD_project/Targeted_C_strelka/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
