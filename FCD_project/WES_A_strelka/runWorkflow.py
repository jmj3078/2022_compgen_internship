#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/opt/biogrids/x86_64-linux/strelka/2.9.2/bin/configureStrelkaSomaticWorkflow.py --normalBam ./bam/WES_A_Normal.sorted.RGadded.marked.realigned.fixed.recal.bam --tumorBam ./bam/WES_A_Disease.sorted.RGadded.marked.realigned.fixed.recal.bam --referenceFasta /data/references/b37/human_g1k_v37_decoy.fasta --callRegions ./bed/wes.bed.gz --runDir ./WES_A_strelka'
#
...
main(r"/scratch/2022_summer_internship/mjcho/FCD_project/WES_A_strelka/runWorkflow.py.config.pickle","StrelkaSomatic",StrelkaSomaticWorkflow)
